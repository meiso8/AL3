...
public:
	...
	/// <param
	/// name="enableDebugLayer">DebugLayerを有効にするかどうか。矩形を数千という単位で描画してDebug版だと重い時のみfalseにしても良い</param>
	/// </summary>
	static void Initialize(
	    const char* title, int width = 1280, int height = 720, bool enableDebugLayer = true);
